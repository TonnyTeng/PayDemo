...
-(char *) Request_GetMac1:(int)macMode
                ...
                otherData:(char*)_oData
                 oDataLen:(int)_oDataLen
                     data:(char*)_data dataLen:(int)_dataLen;
-(void) Request_GetMac2:(int)ebcMode
                     mode:(int)macMode
                 keyIndex:(int)_keyIndex
                   random:(char*)_random
                randomLen:(int)_randomLen
...
//3.14 请求psam卡DES加密 (0204H)
- (void)Request_DESEnc:(int)mode
              pinIndex:(int)index
                random:(char*)_random
             randomLen:(int)_randomLen
                  data:(char*)_data
...
//3.15 请求psam卡DES解密(0222H)
- (void)Request_DESDec:(int)mode
              pinIndex:(int)index
                random:(char*)_random
             randomLen:(int)_randomLen
                  data:(char*)_data
               ...
               timeOut:(int)_timeOut;
//3.16应用初始化(0221)
- (void)Request_InitApp;
//3.3 获取磁卡卡号（0300）
- (void)request_cardNo;
//3.4 读取磁道明文
- (void)request_TrackExpress;
/*!
 @method
 @abstract 更新TMK 0926
 @discussion 更新工作秘钥
